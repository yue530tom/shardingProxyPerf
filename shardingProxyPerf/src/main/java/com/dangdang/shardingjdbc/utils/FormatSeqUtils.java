...
public class FormatSeqUtils
{
  ...
  {
    return Long.valueOf(Long.parseLong(String.valueOf(hostAddress) + 
      String.format(new StringBuilder().append("%0").append(formatLength - String.valueOf(hostAddress).length()).append("d").toString(), new Object[] { seq })));
  }
}
